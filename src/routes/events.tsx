...
import heroEvents from "@/assets/hero/hero-event.jpg";
...
function Events() {
  ...
  <PageHero
    ...
    subtitle="Jangan lewatkan momen budaya yang hidup di Sosromenduran."
    image={heroEvents} 
  />
  <section className="mx-auto max-w-7xl px-4 md:px-8 pt-10 pb-20 grid gap-6 md:grid-cols-2 lg:grid-cols-3">
        {events.map((e) => (
